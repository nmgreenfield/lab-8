...
scrape_cheese <- function(url) {
    ...
    # Grab elements from the page
    get_text_from_page(page, ".summary_milk")
    get_text_from_page(page, ".summary_country")
    get_text_from_page(page, ".summary_family")
    get_text_from_page(page, ".summary_moisture_and_type")
    get_text_from_page(page, ".summary_taste")
}
```
